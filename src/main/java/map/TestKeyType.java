...
public class TestKeyType {
	public static void main(String[] args) {
		HashMap integerhashMap = new HashMap<Integer, String>(){{put(100, "100");}};
		HashMap longhashMap = new HashMap<Long, String>(){{put(100L, "100");}};
		if (!ObjectUtils.isEmpty(integerhashMap.get(100))){
			System.out.println("intmap get int: 100");
		}

		if (!ObjectUtils.isEmpty(integerhashMap.get(100L))){
			System.out.println("intmap get long: 100");
		}

		if (!ObjectUtils.isEmpty(longhashMap.get(100))){
