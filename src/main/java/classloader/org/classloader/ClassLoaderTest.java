...
public class ClassLoaderTest {
	...
	//第二行结果说明：AppClassLoader的父类加器是ExtClassLoader，即parent=ExtClassLoader。
	//第三行结果说明：ExtClassLoader的父类加器是Bootstrap ClassLoader，因为Bootstrap ClassLoader不是一个普通的Java类，所以ExtClassLoader的parent=null，所以第三行的打印结果为null就是这个原因。
