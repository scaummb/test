...
public class HelpCenterDocumentTreeDTO {
	private List<HelpCenterDocumentTreeDTO> dtos;
	private Long id;
	...
	public List<HelpCenterDocumentTreeDTO> getDtos() {
		return dtos;
	}

	public void setDtos(List<HelpCenterDocumentTreeDTO> dtos) {
		this.dtos = dtos;
	}
