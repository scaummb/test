...
public class LambdaSamples {
	public static void main(String[] args) {
		...
		testNoArgButReturnVal testNoArgButReturnVal2 = () -> {
			return 1;
		};
		//一个参数，有返回值
		testArgWithReturnVal testArgWithReturnVal = (String a) -> {
			return 1;
		};
		testArgWithReturnVal testArgWithReturnVal2 = (a) -> {
			return 1;
		};
		testArgWithReturnVal testArgWithReturnVal3 = a -> {
			return 1;
		};
		testArgWithReturnVal testArgWithReturnVal4 = a -> 1;
		//两个参数，有返回值
		testArgsWithReturnVal testArgsWithReturnVal = (String a, Integer b) -> {
			return 1;
		};
		testArgsWithReturnVal testArgsWithReturnVal2 = (a, b) -> {
			return 1;
		};
		...
		testArgsWithNoReturnVal testArgsWithNoReturnVal2 = (String a, Integer b) -> {
